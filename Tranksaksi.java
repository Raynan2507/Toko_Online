...
public class Tranksaksi {
 ...
 public void prosesTransaksi (Member member, Tranksaksi transaksi, Barang barang) {
     Scanner myObj = new Scanner(System.in);
             ...
             do{
                 ...
                 if (temp!=99){
                     idBarang.add(temp);
                     System.out.println(barang.getNamaBarang(idBarang.get(i))+"sebagai berikut");
...
banyaknya){
 ...
 return this.idMember.size();
    ...
    void prosesTranksaksi(Member member, Tranksaksi transaksi, Barang barang) {
